...
(exports.id = 539),
    ...
    (exports.modules = {
        1714: (e, t, n) => {
            n.r(t), n.d(t, { toFormData: () => D });
            var r = n(4581),
                a = n(7650);
            let i = 0;
            const s = { START_BOUNDARY: i++, HEADER_FIELD_START: i++, HEADER_FIELD: i++, HEADER_VALUE_START: i++, HEADER_VALUE: i++, HEADER_VALUE_ALMOST_DONE: i++, HEADERS_ALMOST_DONE: i++, PART_DATA_START: i++, PART_DATA: i++, END: i++ };
            let o = 1;
            const d = o,
                E = (o *= 2),
                A = (e) => 32 | e,
            ...
            class l {
                ...
                write(e) {
                    ...
                    const n = e.length;
                    let r = this.index,
                        { lookbehind: a, boundary: i, boundaryChars: o, index: h, state: l, flags: D } = this;
                    ...
                    const u = (e) => {
                        ...
                        b = (e, t, n, r) => {
                            (void 0 !== t && t === n) || this[e](r && r.subarray(t, n));
                        },
                        L = (n, r) => {
                            const a = n + "Mark";
                            a in this && (r ? (b(n, this[a], t, e), delete this[a]) : (b(n, this[a], e.length, e), (this[a] = 0)));
                        };
                    for (t = 0; t < n; t++)
                        switch (((_ = e[t]), l)) {
                            ...
                            case s.HEADER_VALUE:
                                13 === _ && (L("onHeaderValue", !0), b("onHeaderEnd"), (l = s.HEADER_VALUE_ALMOST_DONE));
                                break;
                            ...
                            case s.PART_DATA:
                                if (((r = h), 0 === h)) {
                                    for (t += T; t < f && !(e[t] in o); ) t += c;
                                    (t -= T), (_ = e[t]);
                                }
                                if (h < i.length) i[h] === _ ? (0 === h && L("onPartData", !0), h++) : (h = 0);
                                else if (h === i.length) h++, 13 === _ ? (D |= d) : 45 === _ ? (D |= E) : (h = 0);
                                else if (h - 1 === i.length)
                                    if (D & d) {
                                        if (((h = 0), 10 === _)) {
                                            (D &= ~d), b("onPartEnd"), b("onPartBegin"), (l = s.HEADER_FIELD_START);
                                            break;
                                        }
                                    } else D & E && 45 === _ ? (b("onPartEnd"), (l = s.END), (D = 0)) : (h = 0);
                                if (h > 0) a[h - 1] = _;
                                else if (r > 0) {
                                    const e = new Uint8Array(a.buffer, a.byteOffset, a.byteLength);
                                    b("onPartData", 0, r, e), (r = 0), u("onPartData"), t--;
                                }
                                break;
                            case s.END:
                                break;
                    ...
                    L("onHeaderField"), L("onHeaderValue"), L("onPartData"), (this.index = h), (this.state = l), (this.flags = D);
                }
                end() {
                    if ((this.state === s.HEADER_FIELD_START && 0 === this.index) || (this.state === s.PART_DATA && this.index === this.boundary.length)) this.onPartEnd();
            ...
            async function D(e, t) {
                ...
                u.decode(),
                    (i.onPartBegin = function () {
                        (i.onPartData = T), (i.onPartEnd = R), (s = ""), (o = ""), (d = ""), (E = ""), (A = ""), (h = null), (D.length = 0);
                    }),
                    ...
                    (i.onHeaderEnd = function () {
                        if (((o += u.decode()), (s = s.toLowerCase()), "content-disposition" === s)) {
                            const e = o.match(/\bname=("([^"]*)"|([^()<>@,;:\\"/[\]?={}\s\t]+))/i);
                            e && (E = e[2] || e[3] || ""),
                                (h = (function (e) {
                                ...
                                h && ((i.onPartData = f), (i.onPartEnd = _));
...
//# sourceMappingURL=539.index.js.map
